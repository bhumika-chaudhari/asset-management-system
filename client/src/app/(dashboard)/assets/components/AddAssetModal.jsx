    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "2rem", width: "100%" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%" }}>
        ...
        <button
          ...
          style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "0.75rem 1.25rem", gap: "0.5rem" }}
        >
          <Plus size={18} />
          <span>Add Asset</span>
        </button>
      ...
      <div style={{ display: "flex", width: "100%" }}>
        <div 
          ...
          style={{ position: "relative", display: "flex", alignItems: "center", width: "100%", padding: "0.875rem 1.25rem", gap: "0.75rem" }}
        >
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody className="text-sm text-slate-300">
              {loading ? (
                ...
                <tr>
                  <td colSpan="5" className="text-center text-slate-500" style={{ padding: "4rem" }}>
                  ...
                  >
                    ...
                    <td style={{ padding: "1.25rem 1.5rem" }}>
                      <span
                        ...
                        style={{ display: "inline-flex", alignItems: "center", borderRadius: "9999px", padding: "0.125rem 0.625rem", fontSize: "0.75rem" }}
                      >
                        {asset.status}
                      </span>
                    </td>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", paddingBottom: "1rem" }}>
        <p className="text-sm font-medium text-slate-400">
